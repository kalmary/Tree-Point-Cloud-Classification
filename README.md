...
- Memory-efficient GPU-based k-NN search for faster nearest neighbor computations,
- Model configurability from JSON files for easy architecture adjustments,
- High scalability of model, training, and processing pipelines,
- Improved decoder upsampling for better segmentation quality,
...
│   ├── model.py          #RandLANet model, configurable from dictionary
